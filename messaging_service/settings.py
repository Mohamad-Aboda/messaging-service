...
SECRET_KEY = 'django-insecure-&bof%qrfo+-898*q*bl8hshpyu77or(#s$o#az5!&gt7=s$t%e'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': datetime.timedelta(days=5),  # Set the access token lifetime 10 days just for testing 
    'SLIDING_TOKEN_REFRESH_LIFETIME': datetime.timedelta(days=10),  # Set the refresh token lifetime 15 days just for testing purpose
